"""Asteroid class to represent titular enemy obects"""
import random
import pygame
...
class Asteroid(CircleShape):
    ...
    def split(self) -> None:
        ...
        If not the smallest size, create two new Asteroid objects one size smaller, travelling in randomized directions
        """
        self.kill()
        ...
        asteroid_1 = Asteroid(
            self.position[0], self.position[1], smaller_radius)
        asteroid_2 = Asteroid(
            self.position[0], self.position[1], smaller_radius)
